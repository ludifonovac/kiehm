...
?>
			...
			<h5 class="entry-title">Mietpreise</h5>
			<table class="pricing">
				<tr>
					<td>Kurztarif (4 Std.):</td>
					<td class="table-cell-right"><?php echo get_field('short_term')?number_format(get_field('short_term'), 2, ',', '.'):''; ?>€</td>
				</tr>
				<tr>
					<td>Tagestarif:</td>
					<td class="table-cell-right"><?php echo get_field('daily')?number_format(get_field('daily'), 2, ',', '.'):''; ?>€</td>
				</tr>
				<tr>
					<td>Wochentarif:</td>
					<td class="table-cell-right"><?php echo get_field('weekly')?number_format(get_field('weekly'), 2, ',', '.'):''; ?>€</td>
				</tr>
				<tr>
					<td>Wochenende:</td>
					<td class="table-cell-right"><?php echo get_field('weekend')?number_format(get_field('weekend'), 2, ',', '.'):''; ?>€</td>
				</tr>
			</table>			<button data-name="<?php the_title(); ?>">Reservierungsanfrage</button>
		</div>
...
?>
			...
			<button data-name="<?php the_title(); ?>">Reservierungsanfrage</button>
		</div>
